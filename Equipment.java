...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        // TODO: finish method
        if(!this.name.equals(otherEq.name))
        	return false;
        if(this.count!=otherEq.count)
        	return false;
        if(this.totalWeight!=otherEq.totalWeight)
        	return false;
        if(this.totalPrice!=otherEq.totalPrice)
        	return false;
        if(!this.description.equals(otherEq.description))
        	return false;
        return true;
    }
}
